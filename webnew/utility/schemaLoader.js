module.exports = function(database) {
	...
	database.model('Document', require('../model/document'));
	database.model('Stdenroll', require('../model/student_enroll'));
	database.model('Subenroll', require('../model/subject_enroll'));
	...
	var models = {
		...
		StudentEnroll: database.model('Stdenroll'),
		SubjectEnroll: database.model('Subenroll')
	}
